...
import eu.chargetime.ocpp.jsonserverimplementation.db.tables.records.SchemaVersionRecord;
...
public class SchemaVersion extends TableImpl<SchemaVersionRecord> {
     ...
     */
    public final TableField<SchemaVersionRecord, DateTime> INSTALLED_ON = createField(DSL.name("installed_on"), SQLDataType.TIMESTAMP(0).nullable(false), this, "", new DateTimeConverter());
