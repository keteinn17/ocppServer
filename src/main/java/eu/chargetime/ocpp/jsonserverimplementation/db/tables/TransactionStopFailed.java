...
import eu.chargetime.ocpp.jsonserverimplementation.db.tables.records.TransactionStopFailedRecord;
...
public class TransactionStopFailed extends TableImpl<TransactionStopFailedRecord> {
     ...
     */
    public final TableField<TransactionStopFailedRecord, DateTime> EVENT_TIMESTAMP = createField(DSL.name("event_timestamp"), SQLDataType.TIMESTAMP(6).nullable(false), this, "", new DateTimeConverter());
     ...
     */
    public final TableField<TransactionStopFailedRecord, DateTime> STOP_TIMESTAMP = createField(DSL.name("stop_timestamp"), SQLDataType.TIMESTAMP(6).nullable(false), this, "", new DateTimeConverter());
