...
import eu.chargetime.ocpp.jsonserverimplementation.db.tables.records.TransactionStartRecord;
...
public class TransactionStart extends TableImpl<TransactionStartRecord> {
     ...
     */
    public final TableField<TransactionStartRecord, DateTime> EVENT_TIMESTAMP = createField(DSL.name("event_timestamp"), SQLDataType.TIMESTAMP(6).nullable(false), this, "", new DateTimeConverter());
