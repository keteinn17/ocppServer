...
import eu.chargetime.ocpp.jsonserverimplementation.db.tables.records.TransactionRecord;
...
public class Transaction extends TableImpl<TransactionRecord> {
     ...
     */
    public final TableField<TransactionRecord, DateTime> START_EVENT_TIMESTAMP = createField(DSL.name("start_event_timestamp"), SQLDataType.TIMESTAMP(6).nullable(false), this, "", new DateTimeConverter());
