...
import eu.chargetime.ocpp.jsonserverimplementation.repository.ReservationStatus;
...
public class ReservationRepositoryImpl implements ReservationRepository {
    ...
    public List<Reservation> getReservations(ReservationQueryForm form) throws Exception {
    ...
    private void processType(SelectQuery selectQuery, ReservationQueryForm form) throws Exception {
