...
public class OCPPAuthorizeHandlerTest {
    ...
    public void testOCPPAuthorizeHandler() {
        ...
        AuthorizeRequest testRequest = clientCoreProfile.createAuthorizeRequest("Truong211");
    ...
    @Test
    public void testOCPPReserveNowHandler() {
        String url = "ws://" + apiConfigurations.getWebSocketBaseUrl() + "/" + chargeBoxId;
        AuthorizeRequest testRequest = clientCoreProfile.createAuthorizeRequest("Truong211");
        jsonClient.connect(url, null);
        try {
